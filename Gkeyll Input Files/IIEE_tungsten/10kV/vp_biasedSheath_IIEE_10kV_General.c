...
create_ctx(void)
{
  struct sheath_ctx ctx = {
    ...
    .gauss_E0 = 4.16038766,      // eV
    .gauss_tau = 1.29308248,
    .intWall = 47963249.552866235, // m/J
    .lorentz_norm = 3.687804e-08, // J/m
    .lorentz_E0 = 128.30559935, // keV
    .lorentz_tau = 2.29256116,
    .lorentz_alpha = 1.83743867,
    .lorentz_beta = 1.78685314,
    .gauss_nuclear_norm = 3.312936e-10, // J/m
    .gauss_nuclear_E0 = 2.07646061, // keV
    .gauss_nuclear_tau = 2.60963378,
    .nw = 6.307868549917687e+28,
    .Nx = 1024,
    .Nvi = 64,
    .Nve = 512,
...
main(int argc, char **argv)
{
  ...
  struct gkyl_vm app_inp = {
    .name = "vp_biasedSheath_IIEE_10kV_1x1v_p2",
